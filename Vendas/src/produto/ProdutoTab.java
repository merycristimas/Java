 ...
 * @author JSQLGen
 */
public class ProdutoTab extends javax.swing.JDialog {
    private final java.sql.Connection connection;
    private final java.util.List list;

    /** Construtor do form ProdutoTab
     * @param parent
     * @param connection
     */
    public ProdutoTab(java.awt.Window parent, java.sql.Connection connection) {
        super(parent);
    ...
    public static void showDialog(java.awt.Window parent, java.sql.Connection connection){
        new ProdutoTab(parent, connection);
    }
    ...
    private void refresh() {
        ...
        list.removeAll(list);
        list.addAll(ProdutoDAO.loadView(connection));
    ...
    private void initComponents() {
        ...
        setTitle("Tabela de Produto");
        setModal(true);
        tTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Id", "Nome", "CodBarras", "Categoria", "Quantidade", "ValorCusto", "ValorVenda"
            }
        ) {
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        produto = ProdutoForm.showInputDialog(this, connection, produto);
        if(produto!=null) {
            try {
    ...
    private void bRemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                Produto produto = ProdutoDAO.loadById(connection, (Integer)tTable.getValueAt(tTable.getSelectedRow(), 0));
                if(javax.swing.JOptionPane.showConfirmDialog(this, "Deseja excluir o Produto "+produto.getId()+"?","Questão",javax.swing.JOptionPane.OK_CANCEL_OPTION)==javax.swing.JOptionPane.OK_OPTION) {
                    ProdutoDAO.delete(connection, produto);
    ...
    private void bPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintActionPerformed
        ...
        print += "<caption>Tabela de Produto</caption>";
        print += "<tr>";
