...
public class ClienteTab extends javax.swing.JDialog {
    ...
    /** Construtor do form ClienteTab
     * @param parent
     * @param connection
     */
    public ClienteTab(java.awt.Window parent, java.sql.Connection connection) {
        super(parent);
    ...
    public static void showDialog(java.awt.Window parent, java.sql.Connection connection){
        new ClienteTab(parent, connection);
    }
    ...
    private void refresh() {
        ...
        list.removeAll(list);
        list.addAll(ClienteDAO.loadView(connection));
    ...
    private void initComponents() {
        ...
        tTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Cpf", "Nascimento", "Tel.Fixo", "Tel.Celular", "Email"
            }
        ) {
        ...
        if (tTable.getColumnModel().getColumnCount() > 0) {
            ...
            tTable.getColumnModel().getColumn(3).setMinWidth(120);
            tTable.getColumnModel().getColumn(3).setPreferredWidth(120);
            tTable.getColumnModel().getColumn(3).setMaxWidth(120);
            tTable.getColumnModel().getColumn(4).setMinWidth(120);
            tTable.getColumnModel().getColumn(4).setPreferredWidth(120);
            tTable.getColumnModel().getColumn(4).setMaxWidth(120);
            tTable.getColumnModel().getColumn(5).setMinWidth(120);
            tTable.getColumnModel().getColumn(5).setPreferredWidth(120);
            tTable.getColumnModel().getColumn(5).setMaxWidth(120);
        }
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        cliente = ClienteForm.showInputDialog(this, connection, cliente);
        if(cliente!=null) {
            try {
    ...
    private void bRemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                Cliente cliente = ClienteDAO.loadById(connection, (Integer)tTable.getValueAt(tTable.getSelectedRow(), 0));
                if(javax.swing.JOptionPane.showConfirmDialog(this, "Deseja excluir o Cliente "+cliente.getId()+"?","Questão",javax.swing.JOptionPane.OK_CANCEL_OPTION)==javax.swing.JOptionPane.OK_OPTION) {
                    ClienteDAO.delete(connection, cliente);
    ...
    private void bPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintActionPerformed
        ...
        print += "<caption>Tabela de Cliente</caption>";
        print += "<tr>";
