 ...
 * @author cta
 */
public class InsumoTab extends javax.swing.JDialog {

    private final Session session;
    private final List<Insumo> lista;
     ...
     * @param session
     */
    public InsumoTab(java.awt.Window parent, Session session) {
        super(parent);
    ...
    private void refresh() {
        ...
        //Obtem uma lista de insumos do banco de dados
        lista.addAll(InsumoDAO.loadList(session));
        ...
        for (Insumo c : lista) {
            ...
            linha.add(c.getQuantidade());
            linha.add(c.getValor("#,##00.0"));
    ...
    private void initComponents() {
        ...
        tTabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Categoria", "Unidade", "Quantidade", "Valor"
            }
        ) {
    ...
    private void bInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bInserirActionPerformed
        Insumo c = new Insumo();           //Instancia novo insumo
        c = InsumoForm.showDialog(this, c); //Exibe o formulário
        if (c != null) {                         //Se o objeto editado não for nulo
            InsumoDAO.save(session, c);     //Salva
            refresh();                       //Atualiza tabela
        }
    }//GEN-LAST:event_bInserirActionPerformed

    private void bEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarActionPerformed
        Insumo c = lista.get(tTabela.getSelectedRow()); //Obtém insumo da lista
        c = InsumoForm.showDialog(this, c); //Exibe o formulário
        if (c != null) {                     //Se o objeto editado não for nulo
            InsumoDAO.save(session, c);     //Salva
            refresh();                       //Atualiza tabela
    ...
    private void bExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExcluirActionPerformed
        Insumo c = lista.get(tTabela.getSelectedRow()); //Obtém insumo da lista
        Integer resposta = JOptionPane.showConfirmDialog(this, "Deseja excluir o insumo " + c.getNome() + "?");
        if (resposta == JOptionPane.YES_OPTION) {
            InsumoDAO.delete(session, c);
            refresh();
        }
